...
from .views import ProductListView,ProductDetailView,RoyalCaninProducts,CategoryDetailView,search,ProductCreateView,ProductUpdateView,ProductDeleteView,ProductAdminView
